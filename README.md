...
```js
npm install react-pdftotext-temppackage
```
...
This project was forked from react-pdftotext (https://www.npmjs.com/package/react-pdftotext). This is intended as a temporary bug patch.
